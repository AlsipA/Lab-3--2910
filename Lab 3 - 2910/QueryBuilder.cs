...
namespace Lab_3___2910
{
    public class QueryBuilder : IDisposable
    {
        ...
        public void Create<T>(T obj) where T : IClassModel
        {
            ...
            //won't lie got some help from kacie on this part 
            ...
            var command = connection.CreateCommand();
            command.CommandText = $"INSERT INTO {typeof(T).Name}({sb}) VALUES ({stringBuilder})";
         ...
         *      command.CommandText = $"INSERT INTO {typeof(T).Name}({names}) VALUES ({values})";
         *      foreach (var property in properties)
         *      {
         *          if(property.Name == "Id")
         *          {
         *              command.Parameters.AddWithValues($"@{property.Name}", obj.Id);
         *          }
         *          command.Parameters.AddWithValues($"@{property.Name}", property.GetValue(obj));
         *      }
